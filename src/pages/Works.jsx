function Work() {
  return (
    <div className="h-screen p-40 bg-backgroundColor lg:grid grid-cols-4 gap-10 items-center text-xl" >
      ...
      <div className="p-5">
        Adjustable Double Burner Forge: After making a deal to clean out a shop in exchange for help welding and materials, my adjustable double burner forge was plasma cut and welded together.
      </div>
